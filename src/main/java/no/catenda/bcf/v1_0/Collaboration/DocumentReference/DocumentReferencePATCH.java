...
public class DocumentReferencePATCH {
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof DocumentReferencePATCH) == false) {
            return false;
        }
        DocumentReferencePATCH rhs = ((DocumentReferencePATCH) other);
